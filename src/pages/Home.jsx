    ...
    <main>
        ...
        <div className="container">
          ...
          <Reveal className="byob-single byob-mobile-only">
            <Link to="/byob" className="byob-single-link">
              <img src="images/bring-your-own-bag-of-chips-transparent.png" alt="Introducing Bring Your Own Bag of Chips" className="byob-single-img" />
            </Link>
          </Reveal>
        </div>
      </section>
      ...
      <section className="home-menu-section section" style={{ background:'var(--black)' }}>
        <div className="container" style={{ textAlign:'center', marginBottom:36 }}>
          <h2 className="section-title home-menu-title">OUR <span className="red">MENU</span></h2>
