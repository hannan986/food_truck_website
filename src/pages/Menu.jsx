...
const MENU = {
  bowls: {
    ...
    items: [
      { name: 'Chicken Over Rice',        price:  9.99, desc: 'Juicy marinated chicken over fluffy rice with fresh veggies and signature sauces.', note: '✓ Rice Base', img: 'lam_over_rice.jpg' },
